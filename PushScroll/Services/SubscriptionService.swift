...
final class SubscriptionService: ObservableObject {
    static let monthlyProductID = "com.pushscroll.premium.monthly"
    static let yearlyProductID = "com.pushscroll.premium.yearly"
    ...
    private let logger = Logger(subsystem: "com.pushscroll.app", category: "StoreKit")
