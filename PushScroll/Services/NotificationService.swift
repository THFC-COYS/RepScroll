...
final class NotificationService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.pushscroll.app", category: "Notifications")
    private let reminderIdentifier = "com.pushscroll.daily.reminder"
